...
public class MathUtils {
    ...
    public static double tangent(DoublePoint p0, DoublePoint p1, DoublePoint p2, DoublePoint p3, DoublePoint q0, DoublePoint q1) {
        double cprodA = cprod(p0, p1, q0, q1);
        double cprodB = cprod(p1, p2, q0, q1);
        double cprodC = cprod(p2, p3, q0, q1);

        double a = cprodA - 2 * cprodB + cprodC;
        double b = -2 * cprodA + 2 * cprodB;
        double c = cprodA;
